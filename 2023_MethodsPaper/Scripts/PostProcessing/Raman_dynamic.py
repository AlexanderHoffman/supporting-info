...
# Calculation of dynamic Raman spectra
...
dip_E0 = np.genfromtxt('../dipole/E0/dipole.txt')[:10000,:]
dip_Ex = np.genfromtxt('../dipole/Ex/dipole.txt')[:10000,:]
dip_Ey = np.genfromtxt('../dipole/Ey/dipole.txt')[:10000,:]
dip_Ez = np.genfromtxt('../dipole/Ez/dipole.txt')[:10000,:]
print len(dip_Ez)
